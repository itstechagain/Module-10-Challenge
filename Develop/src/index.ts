        ...
        inquirer.prompt([
          {
            ...
            name: 'managerId',
            message:
              'Select a manager for the selected empoloyee',
            choices: managerChoices,
          },
        ])
    ...
    inquirer.prompt([
      {
        ...
        name: 'roleId',
        message:
          'Choose a role to remove. (Warning: This removes all assosciated employees)',
        choices: roleChoices,
      },
    ])
...
function removeDepartment() {
  db.findAllDepartments().then(({ rows }) => {
    ...
    inquirer.prompt({
      ...
      name: 'departmentId',
      message:
        'Choose a department to remove. (Warning: This removes all associated roles and employees)',
      choices: departmentChoices,
    })
